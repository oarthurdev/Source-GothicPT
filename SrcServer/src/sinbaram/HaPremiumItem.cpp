...
int TelePort_FieldNum[TELEPORT_FIELDMAX][3] = {
	...
	//{ 32, 43, 120 }, // Torre Sem Fim 3º Andar
	//{ 33, 44, 110 }, // Mina de Gelo 1º Andar 
	//{ 34, 46, 110 }, // Laboratório Secreto
	//{ 35, 47, 110 }, // Arma Secreta 
	//{ 36, 48, 110 }, // Abismo do Mar 1º Andar
	//{ 37, 49, 110 } // Abismo do Mar 2º andar
...
int cHaPremiumItem::UsePremiumItem(int kind)
{
	...
	switch(kind)
	{
		...
		case 123:
		haCastleSkillUseFlag = 1;
		SetUpKeepItem(nsPremiumItem::EXPUP_POTION, SINITEM_TIME_2DAYS, true, UpKeepItemName[1], 30);
		break;
