...
void cHaQuest::init()
{
	...
	lpQuestButtonImage[2] = LoadDibSurfaceOffscreen("Assets\\GUI\\Inventory\\LeftArrow.bmp");
	lpQuestButtonImage[3] = LoadDibSurfaceOffscreen("Assets\\GUI\\Inventory\\RightArrow.bmp");
