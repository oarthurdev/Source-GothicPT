...
static DIRECTDRAWSURFACE		    s_BL_lpDDSurfaceBuff[DMAX_BELLATRA_DDS_IMAGELIST];
...
void CreateBellatraFontEffect(void)
{
	...
	s_EventScore_Font = ::CreateFont(16, 0, 0, 0, FW_THIN, FALSE, FALSE, FALSE, ANSI_CHARSET | FS_LATIN1, OUT_TT_PRECIS, CLIP_DEFAULT_PRECIS, ANTIALIASED_QUALITY, DEFAULT_PITCH | FF_DONTCARE, "Noto Sans");
#endif
