...
public:
	...
	HoMinMax<D3DVECTOR> GetPartAngle(void) const
	{
		return(PartAngle);
	}
	void SetPartAngle(const HoMinMax<D3DVECTOR> &data)
	{
		PartAngle = data;
	}
protected:
...
public:
	...
	HoMinMax<D3DVECTOR> GetLocalAngle(void) const
	{
		return(LocalAngle);
	}
	void SetLocalAngle(const HoMinMax<D3DVECTOR> &data)
	{
		LocalAngle = data;
	}
protected:
...
public:
	...
	HoMinMax<D3DVECTOR> GetVelocity(void) const
	{
		return(Velocity);
	}
	void SetVelocity(const HoMinMax<D3DVECTOR> &data)
	{
		Velocity = data;
	}
...
public:
	...
	D3DVECTOR PartAngle;
	D3DVECTOR PartAngleStep;

	D3DVECTOR LocalAngle;
	D3DVECTOR LocalAngleStep;
...
public:
	...
	HoMinMax<D3DVECTOR> GetSpawnDir(void) const
	{
		return(SpawnDir);
	}
	void SetSpawnDir(const HoMinMax<D3DVECTOR> &data)
	{
		SpawnDir = data;
	}

	HoMinMax<D3DVECTOR> GetEmitRadius(void) const
	{
		return(EmitRadius);
	}
	void SetEmitRadius(const HoMinMax<D3DVECTOR> &data)
	{
		EmitRadius = data;
	}

	HoMinMax<D3DVECTOR> GetGravity(void) const
	{
		return(Gravity);
	}
	void SetGravity(const HoMinMax<D3DVECTOR> &data)
	{
		Gravity = data;
	}
...
public:
	...
	HoMinMax<D3DVECTOR> GetPosRange(void) const
	{
		return(PosRange);
	}
	void SetPosRange(const HoMinMax<D3DVECTOR> &data)
	{
		PosRange = data;
	}


	D3DVECTOR GetPos(void) const
	{
		return(Pos);
	}
