...
int InitField()
{
	...
	sField[cnt].AddWarpOutGate(&sField[22], -11088, -41570, 343);
	...
	sField[cnt].AddWarpGate(1962, 71184, 561, 64, 32);
...
#define	OUT_Y	830
	...
	sField[cnt].WarpGate[sField[cnt].WarpGateActiveNum].LimitLevel = 110;
...
{
#ifdef _DEBUG
	//Log::getInstance()->output(LOG_DEBUG, "WARP_FIELD: %d", FieldNum);
#endif
...
int WarpStartField(int* mx, int* mz)
{
	...
	/*if(StageField[lpCurPlayer->OnStageField]->FieldCode == START_FIELD_CASTLE)
	{
		StartNum = START_FIELD_CASTLE;
	}*/
