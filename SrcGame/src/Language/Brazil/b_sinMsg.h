...
sMESSAGEBOX2 sMessageBox2[20] = {
	...
	{"Quantos mercenários ","você deseja contratar?"},
	 {"Quanto crédito"," você deseja trocar?"}
};
...
char* TownName[4] = { "Voltar para Ricarten\r","Voltar para Navisko\r","Voltar para Pillai\r","Voltar para Atlantis\r" };

char* sinAbilityName[50] = {
	"Poder de Ataque: \r",
	"Velocidade da Arma: \r",
	"Alcance: \r",
	"Crítico: \r",
	"Defesa: \r",
	"Taxa de Ataque: \r",
	...
	"Velocidade: \r",
	"Integridade: \r",
	"Regeneração de Mana: \r",
	"Regeneração de Vida: \r",
	"Regeneração de Estamina: \r",
	"Orgânica: \r",
	"Nature Type: \r",
	"Fogo: \r",
	"Gelo: \r",
	...
	"Agilidade: \r",
	"Vitalidade: \r"
	"Nível de Batalha Necessário: \r",
};


char* sinSpecialName[50] = { "Velocidade Atk: \r", "Crítico Adicional: \r", "Def. Adicional: \r", "Abs Adicional: \r",
...
"P. de Atk Adicional: \r", "Taxa de Atk ad.: \r", "Spec. RNG: \r", "Atk Org. Adicional: \r", "Spec. Nature ATK: \r", "Atk Fogo Adicional: \r", "Atk Gelo Adicional: \r",
...
char* SparkDamage = "Poder de Ataque:\r";
...
char* sinAddDamageItem = "Poder de ataque adicional: \r";
char* sinContinueTimeItem = "Duração: \r";
char* BuyPotionMoney = "Ouro:";
char* BuyPotionKind = "Número:";
char* SheltomName2[] = { "Elemento Escuridão","Elemento Chakra","Elemento Equilíbrio","Elemento Terra","Elemento Trovão","Elemento Fé","Elemento Fogo","Elemento Cristal","Elemento Madeira", "Elemento Metal", "Elemento Água", "Elemento Magia","Bellum","Elemento Místico" };

char* AddPercentDamage3 = "Bônus no dano: \r";
...
char* BoosterItemInfo[] = {
	{ "Aumento do HP máximo do \r" },
	{ "Aumento do MP máximo do \r" },
	{ "Aumento do RESS máximo do \r" },
	0,
};
