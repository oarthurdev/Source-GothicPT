...
void Shop::Init()
{
	Image[0] = CreateTextureMaterial("game\\images\\shop\\winshop.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	...
	Image[23] = CreateTextureMaterial("game\\images\\shop\\cat\\CostumeF.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	Image[24] = CreateTextureMaterial("game\\images\\shop\\cat\\CostumeF_.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	...
	/*Image[84] = CreateTextureMaterial("game\\images\\shop\\cat\\Adagas.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	Image[85] = CreateTextureMaterial("game\\images\\shop\\cat\\Adagas_.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	Image[86] = CreateTextureMaterial("game\\images\\shop\\cat\\Fantasmas.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	Image[87] = CreateTextureMaterial("game\\images\\shop\\cat\\Fantasmas_.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);*/
	Image[88] = CreateTextureMaterial("game\\images\\shop\\cat\\force.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	Image[89] = CreateTextureMaterial("game\\images\\shop\\cat\\force_.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	ReadTextures();
}
...
void Shop::Draw()
{
	...
	if (fOpen)
	{
		...
		if (MouseAction(WinX + 15, WinY + 22, 189, 34) || Tag == 1)
			DrawImage(Image[6], WinX + 15, WinY + 48, 189, 34);
		else
			DrawImage(Image[5], WinX + 15, WinY + 48, 189, 34);
		/*DrawImage(Image[15], WinX + 3, WinY + 85 + 3, 207, 2);*/
		if (MouseAction(WinX + 15, WinY + 85 + 7, 189, 34) || Tag == 2)
			DrawImage(Image[12], WinX + 15, WinY + 85 + 7, 189, 34);
		else
			DrawImage(Image[11], WinX + 15, WinY + 85 + 7, 189, 34);
		/*DrawImage(Image[15], WinX + 3, WinY + 85 + 42 + 3, 207, 2);*/
		if (MouseAction(WinX + 15, WinY + 85 + 42 + 7, 189, 34) || Tag == 3)
			DrawImage(Image[14], WinX + 15, WinY + 85 + 42 + 7, 189, 34);
		else
			DrawImage(Image[13], WinX + 15, WinY + 85 + 42 + 7, 189, 34);
		/*DrawImage(Image[15], WinX + 3, WinY + 85 + 84 + 3, 207, 2);*/
		/*if (MouseAction(WinX + 15, WinY + 85 + 84 + 7, 189, 34) || Tag == 4)
			DrawImage(Image[12], WinX + 15, WinY + 85 + 84 + 7, 189, 34);
		/*else
			DrawImage(Image[11], WinX + 15, WinY + 85 + 84 + 7, 189, 34);
		/*DrawImage(Image[15], WinX + 3, WinY + 85 + 126 + 3, 207, 2);*/
		/*if (MouseAction(WinX + 15, WinY + 85 + 126 + 3 + 7, 189, 34) || Tag == 5)
			DrawImage(Image[14], WinX + 15, WinY + 85 + 126 + 3 + 7, 189, 34);
		/*else
			DrawImage(Image[13], WinX + 15, WinY + 85 + 126 + 3 + 7, 189, 34);
		/*DrawImage(Image[15], WinX + 3, WinY + 85 + 168 + 6, 207, 2);*/

		if (Tag == 1)
		{
			if (MouseAction(WinX + 214, WinY + 43, 79, 26) || SubTag == 1)
				DrawImage(Image[18], WinX + 214, WinY + 43, 79, 26);
			else
				DrawImage(Image[17], WinX + 214, WinY + 43, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 70, 103, 2);*/
			if (MouseAction(WinX + 214, WinY + 73, 79, 26) || SubTag == 2)
				DrawImage(Image[20], WinX + 214, WinY + 73, 79, 26);
			else
				DrawImage(Image[19], WinX + 214, WinY + 73, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 101, 103, 2);*/
			if (MouseAction(WinX + 214, WinY + 104, 79, 26) || SubTag == 3)
				DrawImage(Image[22], WinX + 214, WinY + 104, 79, 26);
			else
				DrawImage(Image[21], WinX + 214, WinY + 104, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 132, 103, 2);*/

			//Force
			/*
			if (MouseAction(WinX + 214, WinY + 135, 79, 26) || SubTag == 4)
				DrawImage(Image[24], WinX + 214, WinY + 135, 79, 26);
			else
				DrawImage(Image[23], WinX + 214, WinY + 135, 79, 26);
			DrawImage(Image[16], WinX + 212, WinY + 163, 84, 2);
			*/
		}
		...
		if (Tag == 2)
		{
			...
			/*DrawImage(Image[16], WinX + 212, WinY + 29, 103, 2);//Line*/
			...
			/*DrawImage(Image[16], WinX + 212, WinY + 55, 103, 2);//Line*/
			...
			/*DrawImage(Image[16], WinX + 212, WinY + 81, 103, 2);//Line*/
			...
			/*DrawImage(Image[16], WinX + 212, WinY + 107, 103, 2);//Line*/
			...
			/*DrawImage(Image[16], WinX + 212, WinY + 133, 103, 2);//Line*/

			if (MouseAction(WinX + 214, WinY + 197, 79, 26) || SubTag == 22)
				DrawImage(Image[89], WinX + 214, WinY + 197, 79, 26);
			else
				DrawImage(Image[88], WinX + 214, WinY + 197, 79, 26);

			/*DrawImage(Image[16], WinX + 212, WinY + 159, 103, 2);//Line*/

			/*if (MouseAction(WinX + 214, WinY + 197, 79, 26) || SubTag == 23)//Espada
				DrawImage(Image[73], WinX + 214, WinY + 197, 79, 26);
			else
				DrawImage(Image[72], WinX + 214, WinY + 197, 79, 26);

			/*DrawImage(Image[16], WinX + 212, WinY + 185, 103, 2);//Line*/

			/*if (MouseAction(WinX + 214, WinY + 211, 79, 26) || SubTag == 24)//Lança
				DrawImage(Image[75], WinX + 214, WinY + 211, 79, 26);
			else
				DrawImage(Image[74], WinX + 214, WinY + 211, 79, 26);

			/*DrawImage(Image[16], WinX + 212, WinY + 211, 103, 2);//Line	*/

			/*if (MouseAction(WinX + 214, WinY + 237, 79, 26) || SubTag == 25)//Adaga
				DrawImage(Image[85], WinX + 214, WinY + 237, 79, 26);
			else
				DrawImage(Image[84], WinX + 214, WinY + 237, 79, 26);

			/*DrawImage(Image[16], WinX + 212, WinY + 237, 103, 2);//Line*/

			/*if (MouseAction(WinX + 214, WinY + 263, 79, 26) || SubTag == 26)//Fantasma
				DrawImage(Image[87], WinX + 214, WinY + 263, 79, 26);
			else
				DrawImage(Image[86], WinX + 214, WinY + 263, 79, 26);*/

				/*DrawImage(Image[16], WinX + 212, WinY + 263, 103, 2);//Line
				DrawImage(Image[16], WinX + 212, WinY + 289, 103, 2);//Line*/
		}

		if (Tag == 3)
		{
			if (MouseAction(WinX + 214, WinY + 43, 79, 26) || SubTag == 10)
				DrawImage(Image[24], WinX + 214, WinY + 43, 79, 26);
			else
				DrawImage(Image[23], WinX + 214, WinY + 43, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 70, 103, 2);*/
			if (MouseAction(WinX + 214, WinY + 73, 79, 26) || SubTag == 11)
				DrawImage(Image[24], WinX + 214, WinY + 73, 79, 26);
			else
				DrawImage(Image[23], WinX + 214, WinY + 73, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 101, 103, 2);*/
			/*if (MouseAction(WinX + 214, WinY + 104, 79, 26) || SubTag == 12)
				DrawImage(Image[51], WinX + 214, WinY + 104, 79, 26);
			else
				DrawImage(Image[50], WinX + 214, WinY + 104, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 132, 103, 2);*/
			/*if (MouseAction(WinX + 214, WinY + 135, 79, 26) || SubTag == 13)
				DrawImage(Image[53], WinX + 214, WinY + 135, 79, 26);
			else
				DrawImage(Image[52], WinX + 214, WinY + 135, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 163, 103, 2);*/

			/*if (MouseAction(WinX + 214, WinY + 166, 79, 26) || SubTag == 14)
				DrawImage(Image[55], WinX + 214, WinY + 166, 79, 26);
			else
				DrawImage(Image[54], WinX + 214, WinY + 166, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 194, 103, 2);*/

			/*if (MouseAction(WinX + 214, WinY + 197, 79, 26) || SubTag == 15)
				DrawImage(Image[57], WinX + 214, WinY + 197, 79, 26);
			else
				DrawImage(Image[56], WinX + 214, WinY + 197, 79, 26);
			/*DrawImage(Image[16], WinX + 212, WinY + 225, 103, 2);*/

			//Orb
			/*
			if (MouseAction(WinX + 214, WinY + 228, 79, 26) || SubTag == 16)
				DrawImage(Image[59], WinX + 214, WinY + 228, 79, 26);
			else
				DrawImage(Image[58], WinX + 214, WinY + 228, 79, 26);
			DrawImage(Image[16], WinX + 212, WinY + 256, 84, 2);
			*/
		}
			...
			for (int cnt = 0; cnt < 70; cnt++)
			{
				if (List.item[cnt].SubTag && List.item[cnt].SubTag == SubTag)
				{
					...
					if (WinY + 48 + SlotY < 370 && WinY + 48 + SlotY > WinY + 47)
						DrawFontText(WinX + 90, WinY + 48 + SlotY, List.item[cnt].Name, RGB(255, 255, 255), true);
...
void Shop::Button()
{
	...
	{
		int WinX = 40, WinY = 70, cnt2 = 0;
		if (MouseAction(WinX + 30, WinY + 48, 189, 34) && Tag != 1)
			Tag = 1;
		if (MouseAction(WinX + 30, WinY + 85 + 7, 189, 34) && Tag != 2)
			Tag = 2;
		if (MouseAction(WinX + 30, WinY + 85 + 42 + 7, 189, 34) && Tag != 3)
			Tag = 3;
		if (MouseAction(WinX + 30, WinY + 85 + 84 + 7, 189, 34) && Tag != 4)
			Tag = 4;
		if (MouseAction(WinX + 30, WinY + 85 + 126 + 3 + 7, 189, 34) && Tag != 5)
			Tag = 5;
...
char* Shop::coinsInvetario()
{
	HDC	hdc = NULL;
	char strBuff[128];
	char sCoin[128] = { 0 };

	NumLineComa(Coin, sCoin);
	/*wsprintf(strBuff, "%s coins", sCoin);
	dsTextLineOut(379, 500, strBuff, lstrlen(strBuff));
	//POSIÇÃO NUMEROS COIN
	*/
	return sCoin;
}
