...
int Skill_DMastery_Level = 0;
int Skill_AMastery_Evade = 0;
...
int OpenPlaySkill(sSKILL *lpSkill)
{
	...
	case SKILL_GRAND_HEALING:
		if (/*InterfaceParty.PartyMemberCount > 0 && */ cParty.MemberCount > 0 && lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
	...
	case SKILL_CURSELAZY:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_CURSELAZY;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_C_HUNT:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_C_HUNT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_A_MIGAL:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_A_MIGAL;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_R_MAKER:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_R_MAKER;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
			lpCurPlayer->MotionLoop = 1;
			SendProcessSKillToServer(SKILL_PLAY_R_MAKER, lpSkill->Point, 0, 0);
			flag++;
		}
		break;
	case SKILL_L_GHOST:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_L_GHOST;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_R_KNIGHT:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_R_KNIGHT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
			...
			SendProcessSKillToServer(SKILL_PLAY_R_KNIGHT, lpSkill->Point, 0, 0);
		}
		break;
	case SKILL_A_MIDRANDA:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_A_MIDRANDA;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_M_PRAY:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_M_PRAY;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_S_SHOCK:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_S_SHOCK;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
			lpCurPlayer->MotionLoop = 1;
			dm_SelectRange(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, SoulChock_Range[lpSkill->Point - 1], FALSE);
			dm_SendRangeDamage(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, 0, 0, 0, 0, 0, lpCurPlayer->AttackSkil);
			flag++;
		}
		break;
	...
	/*case SKILL_POLLUTED:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_POLLUTED;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, 0, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 76;
			lpCurPlayer->MotionLoop = 1;

			dm_SelectDamageCount(lpCurPlayer, Polluted_AttackNum[lpSkill->Point - 1], Polluted_Area[lpSkill->Point - 11]);
			dm_SendRangeDamage(lpCurPlayer->pX, lpCurPlayer->pY, lpCurPlayer->pZ, 0, lpCurPlayer->smCharInfo.Attack_Damage[0], lpCurPlayer->smCharInfo.Attack_Damage[1], 0, 0, lpCurPlayer->AttackSkil);
...
int PlaySkillAttack(sSKILL *lpSkill, smCHAR *lpChar)
{
	...
	case SKILL_STINGGER:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_STINGGER;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
	...
	case SKILL_R_HIT:
		...
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_R_HIT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_WISP:
...

		{
			...
			smTransCommand.code = OpCode::OPCODE_WISP;
			smTransCommand.WParam = Wisp_Reduction[lpSkill->Point - 1];
			smTransCommand.LParam = Wisp_UseTime[lpSkill->Point - 1];
	...
	case SKILL_V_STAB:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_V_STAB;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			cnt = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
			lpCurPlayer->MotionLoopSpeed = cnt;
			lpCurPlayer->MotionLoop = 1;
		}
		return TRUE;
	case SKILL_V_THRONE:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_V_THRONE;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_S_SWORD:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_S_SWORD;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			cnt = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
	...
	case SKILL_B_UP:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_B_UP;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			cnt = GetAttackSpeedFrame(lpCurPlayer->smCharInfo.Attack_Speed, 1);
	...
	case SKILL_F_WIND:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_F_WIND;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_P_SHADOW:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE && lpSkill->Point)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_P_SHADOW;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
			lpCurPlayer->MotionLoop = 1;
			dm_SendTransDamage(lpChar, 0, 0, 0, 0, lpCurPlayer->AttackSkil, 0);
		}
		return TRUE;
	...
	case SKILL_DARKBOLT:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_DARKBOLT;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_DARKWAVE:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_DARKWAVE;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_S_FLARE:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_S_FLARE;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_S_MANACLE:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_S_MANACLE;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_JUDGE:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE)
		{
			lpCurPlayer->AttackSkil = SKILL_PLAY_JUDGE;
			lpCurPlayer->AttackSkil |= (lpSkill->Point << 8);
			lpCurPlayer->BeginSkill(lpCurPlayer->AttackSkil, 0, lpChar, 0, 0, 0);
			lpCurPlayer->SetMotionFromCode(CHRMOTION_STATE_SKILL);
			lpCurPlayer->MotionLoopSpeed = 70;
	...
	case SKILL_SOUL_BREAKER:
		if (lpSkill->Skill_Info.FuncPointer() == TRUE) {
			...
			lpCurPlayer->smCharInfo.Attack_Rating += (lpCurPlayer->smCharInfo.Attack_Rating * Soul_Breaker_AttackRate[lpSkill->Point - 1]) / 100;
