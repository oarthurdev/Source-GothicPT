...
extern char szReiArena[32];
extern int ChatBuffCnt;
extern int ChatScrollPoint;
extern int DispChatMsgHeight;
extern int DispChatMode;
extern int EventBattleArena;
extern DWORD EventBattleArenaTime;
extern int QuestDiaryState;
extern int QuestDiaryKill1;
extern int QuestDiaryKill2;
extern int CharBattleLevel;
extern int CharBattleExp1;
extern int CharBattleExp2;
extern int BellatraEffectInitFlag;
extern DWORD ClanTop2;
extern DWORD ClanTop3;
...
extern int Gladiador();
extern int NotGladiador();
...
extern BATTLE_ARENA_POINT Battle;
...
extern std::unordered_map<DWORD, sITEMINFO> mapItemInfo;

extern bool bSendGetItemInfoPerf;
