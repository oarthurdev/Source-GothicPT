...
BOOL FindFileRecursive(char *path, char *fileName)
{
	...
	WIN32_FIND_DATA wfd;
	BOOL bResult = TRUE;
	char drive[MAX_RES_DRIVE] = { 0 };
	char dir[MAX_RES_PATH] = { 0 };
	char newpath[MAX_RES_PATH] = { 0 };
...
static char sinDecode[512] = { 0 };
static char sinLine[512] = { 0 };
