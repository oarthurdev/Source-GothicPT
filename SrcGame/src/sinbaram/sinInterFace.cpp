...
char *HaEffectFilePath[] = {
	0,
	"game\\GUI\\Interface\\defense.tga",
	"game\\GUI\\Interface\\block.tga",
	"game\\GUI\\Interface\\Evade.tga",
	0,
};
...
void cINTERFACE::Init()
{
	...
	MatMenu[0] = CreateTextureMaterial("game\\GUI\\Interface\\Menu-1.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatMenu[1] = CreateTextureMaterial("game\\GUI\\Interface\\Menu-2.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	MatChatDefault[0] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatDefault-1.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatChatDefault[1] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatDefault-2.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	MatChatSmall[0] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatSmall-1.png", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatChatSmall[1] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatSmall-2.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	MatChatDoc[0] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatDoc-1.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatChatDoc[1] = CreateTextureMaterial("game\\GUI\\Interface\\Chat\\ChatDoc-2.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);


	MatExitMenu = CreateTextureMaterial("game\\GUI\\Interface\\ExitMenu.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);


	MatClock = CreateTextureMaterial("game\\GUI\\Interface\\Clock.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatComPass = CreateTextureMaterial("game\\GUI\\Interface\\Compass.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);

	MatLife = CreateTextureMaterial("game\\GUI\\Interface\\ShadowLife.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatMana = CreateTextureMaterial("game\\GUI\\Interface\\ShadowMana.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
	MatStamina = CreateTextureMaterial("game\\GUI\\Interface\\ShadowStamina.tga", 0, 0, 0, 0, SMMAT_BLEND_ALPHA);
...
{
	lpLIFE = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_Life.bmp");
	lpMP = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_Mana.bmp");
	lpSTM = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_Stamina.bmp");

	lpButton[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bStatus.bmp");
	lpButton[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bInvenTory.bmp");
	lpButton[2] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bSkill.bmp");
	lpButton[3] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bParty.bmp");
	lpButton[4] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bQuest.bmp");
	lpButton[5] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bSystem.bmp");

	lpButton2[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bStatus-1.bmp");
	lpButton2[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bInvenTory-1.bmp");
	lpButton2[2] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bSkill-1.bmp");
	lpButton2[3] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bParty-1.bmp");
	lpButton2[4] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bQuest-1.bmp");
	lpButton2[5] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\bSystem-1.bmp");

	lpInfoBox[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\StatusInfo.bmp");
	lpInfoBox[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\InvenInfo.bmp");
	lpInfoBox[2] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\SkillInfo.bmp");
	lpInfoBox[3] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\PartyInfo.bmp");
	lpInfoBox[4] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\QuestInfo.bmp");
	lpInfoBox[5] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\SystemInfo.bmp");


	lpMenuButton[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Option.bmp");
	lpMenuButton[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Setting.bmp");
	lpMenuButton[2] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Exit.bmp");


	lpWalk = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Button\\Walk.bmp");

	lpChatShowButton = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Chat\\ChatDownButton.bmp");


	lpSun = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Flash\\Sun.bmp");
	lpMoon = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Flash\\Moon.bmp");
	...
	lpBar_Anger = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\sinGage\\Bar_Anger.bmp");
	lpBar_Time = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\sinGage\\Bar_Time.bmp");
	lpBar_Exp = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\sinGage\\Bar_Exp.bmp");
	lpButton_Anger = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\sinGage\\Button_Anger.bmp");

	lpRunInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\Run.bmp");
	lpWalkInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\Walk.bmp");

	lpCameraHandInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\Camera_Hand.bmp");
	lpCameraFixInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\Camera_Fix.bmp");
	lpCameraAutoInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\Camera_Auto.bmp");

	lpMapOnInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\MapOn.bmp");
	lpMapOffInfo = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ButtonInfo\\MapOff.bmp");

	lpMapOnImage = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Button\\MapOnImage.bmp");
	lpCameraImage[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Button\\AutoCameraImage.bmp");
	lpCameraImage[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Button\\PixCameraImage.bmp");

	lpLIFESpot = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_LifeSpot.bmp");
	lpSTMSpot = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_StaminaSpot.bmp");
	lpMANASpot = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\Bar_ManaSpot.bmp");

	lpReStartMain = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ReStart\\ReStartMain.bmp");
	lpReStartButton[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ReStart\\ReStart_Field.bmp");
	lpReStartButton[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ReStart\\ReStart_Town.bmp");
	lpReStartButton[2] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\ReStart\\ReStart_Exit.bmp");


	lpSelectSkill_Main[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\SkillIcon\\G_Select_Skill.bmp");
	lpSelectSkill_Main[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\SkillIcon\\Select_Skill.bmp");

	lpSelectChangeJob[0] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\SkillIcon\\G_Select_ChangeJob.bmp");
	lpSelectChangeJob[1] = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\SkillIcon\\Select_ChangeJob.bmp");

	lpTime7 = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\SkillIcon\\Select_ChangeJob.bmp");

	lpGrowInterLeft = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\inter_01.bmp");
	lpGrowInterMiddle = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\inter_02.bmp");
	lpGrowInterRight = LoadDibSurfaceOffscreen("game\\GUI\\Interface\\inter_03.bmp");
...
void cINTERFACE::Draw()
{
	...
	if(ExitButtonClick)
	{
		dsDrawTexImage(MatExitMenu, 698, 473, 128, 95, 255);

		if(sinMenuBottonPosi == 1)
			DrawSprite(698, 504, lpMenuButton[0], 0, 0, 96, 19);

		if(sinMenuBottonPosi == 2)
			DrawSprite(692, 473, lpMenuButton[1], 0, 0, 93, 20);
	...
	if (sinPKWarningExpFlag) {
		if (sinPKWarnigExpTime <= 15)
			DrawSprite(575, 593, lpBar_Exp, 0, 0, static_cast<int>(sinBmpLength[3] * 2.6), 5);      
...
#include <imm.h>
	...
	if(ImeChatLen != len || ImePositon.x != len || ImePositon.y != y)
	{
		...
		if(smScreenHeight == 600) addPoint = 0;
		else if(smScreenHeight == 768) addPoint = 163;
		else if(smScreenHeight == 1024) addPoint = 420;
	...
	if(SkillMasterFlag == 1)
	{
		...
		if(SkillMasterFlag == 1 && !ShowSkillUpInfo)
		{
			...
			dsTextLineOut( 100, 225 - 80, SkillUseInfoText[0], lstrlen(SkillUseInfoText[0]));
			...
			if(sinSkill.SkillPoint || sinSkill.SkillPoint4)
			{
				...
				dsTextLineOut( 100, 260 - 80, SkillUseInfoText[1], lstrlen(SkillUseInfoText[1]));
				dsTextLineOut( 100, 280 - 80, SkillUseInfoText[2], lstrlen(SkillUseInfoText[2]));
				wsprintf(strBuff, sinMsgSkillPoint, sinSkill.SkillPoint);
				//SelectObject(hdc, sinBoldFont);
				
				SetFontTextColor( RGB(247, 243, 193));
				dsTextLineOut( 100, 310 - 80, strBuff, lstrlen(strBuff));

				wsprintf(strBuff, sinMsgEliteSkillPoint, sinSkill.SkillPoint4);
				//SelectObject(hdc, sinBoldFont);
				
				SetFontTextColor( RGB(147, 243, 193));
				dsTextLineOut( 103, 310 - 55, strBuff, lstrlen(strBuff));
			}
			else
			{
				//SelectObject(hdc, sinFont);
				...
				dsTextLineOut( 100, 260 - 80, SkillUseInfoText[3], lstrlen(SkillUseInfoText[3]));
				dsTextLineOut( 100, 280 - 80, SkillUseInfoText[4], lstrlen(SkillUseInfoText[4]));
...
void cINTERFACE::KeyDown()
{
	...
	if(sinGetKeyClick(VK_RETURN))
	{
		...
		if(!lstrcmpi(sinBuff, "/¸¶±º¿À¿À¿À¿À¿¡¿ä") || !lstrcmpi(sinBuff, "/PassMature"))
		{
			sinBuff[0] = 0;
			sinSecretFlag = 1;
			TestKeyAniFlag = 1;
		...
		if(!lstrcmpi(sinBuff, "/³¯¸°´Ù´¢!") || !lstrcmpi(sinBuff, "/FuckingInven!"))
		{
		...
		if(smConfig.getSecurity() >= AccountTypes::SEC_MODERATOR)
		{
			if(sinBuff[0])
			{
				...
				if(!lstrcmp(sinTestBuff5, "/ÀÓ±º100Äù½ºÆ®") || !lstrcmpi(sinBuff, "/MrIm's100"))
				{
					if(sinTestBuff6[0])
					{
				...
				if(!lstrcmp(sinTestBuff5, "/ÀÓ±ºÃÊº¸Äù½ºÆ®") || !lstrcmpi(sinTestBuff5, "/MrIm'sbeginner"))
				{
					if(sinTestBuff6[0])
					{
					#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹ü4Â÷Äù½ºÆ®") == 0 || lstrcmp(sinTestBuff5, "/Lee4thRankUp") == 0)
				{
					if(sinTestBuff6[0])
					{
					#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹ü3Â÷Äù½ºÆ®") == 0 || lstrcmp(sinTestBuff5, "/Lee3thRankUp") == 0)
				{
					if(sinTestBuff6[0])
					{
					#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹ü·¹º§Äù½ºÆ®") == 0 || lstrcmp(sinTestBuff5, "/LeeResetQuest") == 0)
				{
					if(sinTestBuff6[0])
					{
					#ifdef	_WINMODE_DEBUG
				...
				{
					SendChatMessageToServer("Todas as quest terminadas");
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹ü¼øÂû°¬³×") == 0 || lstrcmp(sinTestBuff5, "/Level") == 0)
				{
					if(sinTestBuff6[0] && sinTestBuff6[0] <= 120)
					{
					#ifdef	_WINMODE_DEBUG
						CheckCharForm();
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üµµ¿ÍÁà¿ä½ºÅ³") == 0 || lstrcmp(sinTestBuff5, "/LeeHelpMeSkill") == 0)
				{
				#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üµµ¿ÍÁà¿ä½ºÅÈ") == 0 || lstrcmp(sinTestBuff5, "/LeeHelpMeStat") == 0)
				{
				#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üÁõÁ¤¾ÆÀÌÅÛ") == 0)
				{
				#ifdef	_WINMODE_DEBUG
					if(MouseItem.Flag)
					{
					...
					SendChatMessageToServer("ÀÌ¹æ¹ü: Àß¾²°Ô(-_-)/ ");
					memset(sinTestBuff5, 0, sizeof(sinTestBuff5));
					memset(sinTestBuff6, 0, sizeof(sinTestBuff6));
					memset(sinBuff, 0, sizeof(sinBuff));
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üÀü¾÷") == 0 || lstrcmp(sinTestBuff5, "/Rank") == 0)
				{
				#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üÀü¾÷Äù½ºÆ®") == 0 || lstrcmp(sinTestBuff5, "/LeeResetRankUp") == 0)
				{
					if(sinTestBuff6[0])
					{
					#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üÄù½ºÆ®ÃÊ±âÈ­") == 0)
				{
				#ifdef	_WINMODE_DEBUG

					SendChatMessageToServer("ÀÌ¹æ¹ü: ÁøÇàÁßÀÎÄù½ºÆ®ÃÊ±âÈ­");
					ClearNowQuest();
					memset(sinTestBuff5, 0, sizeof(sinTestBuff5));
					memset(sinTestBuff6, 0, sizeof(sinTestBuff6));
					memset(sinBuff, 0, sizeof(sinBuff));
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹üÆ÷½º") == 0 || lstrcmp(sinTestBuff5, "/Cancelarforce") == 0)
				{
				//#ifdef	_WINMODE_DEBUG
					SendChatMessageToServer("Força Orb Cancelada! ");
					for(t = 0; t < 10; t++)
					{
				...
				if(lstrcmp(sinTestBuff5, "/ÀÌ¹æ¹ü¼ôÅ°ÃÊ±âÈ­") == 0 || lstrcmp(sinTestBuff5, "/LeeShotKeyReset") == 0)
				{
				#ifdef	_WINMODE_DEBUG
				...
				if(lstrcmp(sinTestBuff5, "/¹öÇÁÁ¦·Î") == 0)
				{
				#ifdef	_WINMODE_DEBUG
					for(int i = 0; i < 4; i++)
					{
					...
					SendChatMessageToServer("ÀÌ¹æ¹ü:¹öÇÁÃÊ±âÈ­ ");
					memset(sinTestBuff5, 0, sizeof(sinTestBuff5));
					memset(sinTestBuff6, 0, sizeof(sinTestBuff6));
					memset(sinBuff, 0, sizeof(sinBuff));
				#endif
...
void cINTERFACE::DrawInterText()
{
	...
	if(InfoMessageBoxPos.x != 0 || InfoMessageBoxPos.y != 0)
		dsTextLineOut( InfoMessageBoxPos.x, InfoMessageBoxPos.y, szInfoMsgBuff5, lstrlen(szInfoMsgBuff5));
	if(ShowExpPercentFlag)
	{
		SetFontTextColor( RGB(202, 254, 251));
		dsDrawOffsetArray = dsARRAY_BOTTOM;
		dsTextLineOut( 515, 586, szInfoMsgBuff6, lstrlen(szInfoMsgBuff6));
		dsDrawOffsetArray = dsARRAY_TOP;
	...
	if(SkillNpcFlag)
	{
		...
		{
			dsTextLineOut( SkillMasterTextXY.x, SkillMasterTextXY.y + 2, szSkillMasterMsg, lstrlen(szSkillMasterMsg));
		}
		if(szReStartMsg2[0])
		{
			dsTextLineOut( SkillMasterTextXY.x, SkillMasterTextXY.y + 18, szSkillMasterMsg2, lstrlen(szSkillMasterMsg2));
		}
