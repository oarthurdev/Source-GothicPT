...
#define REIPVP				(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_8)
#define PLAYERGM			(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_9)
#define PLAYER_TOPLEVEL		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_10)
#define DELAY_GLOBAL   		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_11)
#define PLAYER_ARENA   		(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_12)
#define QUEST_DIARY         (GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_13)
#define BATTLE_LEVEL        (GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_14)


#define BC_SKILL_SILVER        (GROUP_OTHERSKILL | CHANGE_JOB1 | SKILL_15)
#define BC_SKILL_BRONZE        (GROUP_OTHERSKILL | CHANGE_JOB1 | SKILL_16)

#define PLAYERBETA			(GROUP_OTHERSKILL | CHANGE_JOB4 | SKILL_17)
...
public:
	...
	LPDIRECT3DTEXTURE9	lpSkillTitle[4];
	LPDIRECT3DTEXTURE9    lpSkillButton_Gray[17];
	LPDIRECT3DTEXTURE9    lpSkillButton[17];
	LPDIRECT3DTEXTURE9    lpSelectSkill;
	LPDIRECT3DTEXTURE9    lpShortKey[8];
	LPDIRECT3DTEXTURE9    lpSkillBoxBack;
	LPDIRECT3DTEXTURE9    lpWeaponIcon[12];
...
extern sSKILL  ContinueSkill[30];
...
extern sSKILL  TempContinueSkill[30];
