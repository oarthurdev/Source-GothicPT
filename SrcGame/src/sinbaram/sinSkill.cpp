...
sUSESKILL sinSkill;
sSKILL  *pUseSkill;
sSKILL  ContinueSkill[30];
sSKILL  TempContinueSkill[30];
...
/// TIER 5
	...
	{ "ASS"		    ,SKILL_STINGGER 		,"TA10 Stingger" },
	{ "ASS"		    ,SKILL_R_HIT 		    ,"TA12 R_Hit" },
	{ "ASS"		    ,SKILL_D_MASTERY		,"TA14 D_Mastery" },
	{ "ASS"		    ,SKILL_WISP		        ,"TA17 Wisp","As1_WISP.tga" },
	{ "ASS"		    ,SKILL_V_THRONE		    ,"TA20 V_Throne" },
	{ "ASS"		    ,SKILL_ALAS		        ,"TA23 Alas","As2_ALAS.tga" },
	{ "ASS"		    ,SKILL_S_SHOCK		    ,"TA26 S_Shock" },
	{ "ASS"		    ,SKILL_A_MASTERY	    ,"TA30 A_Mastery" },
	{ "ASS"		    ,SKILL_S_SWORD		    ,"TA40 S_Sword" },
	{ "ASS"		    ,SKILL_B_UP		        ,"TA43 B_Up" },
	{ "ASS"		    ,SKILL_INPES		    ,"TA46 Inpes", "As3_INPES.tga" },
	{ "ASS"		    ,SKILL_BLIND		    ,"TA50 Blind", "As3_BLIND.tga" },
	{ "ASS"		    ,SKILL_F_WIND 		    ,"TA60 F_Wind" },
	{ "ASS"		    ,SKILL_F_MASTERY 		,"TA63 F_Mastery" },
	{ "ASS"		    ,SKILL_V_STAB		    ,"TS86 V_Stab" },
	{ "ASS"		    ,SKILL_P_SHADOW		    ,"TA70 P_Shadow" },


	{ "SH"		,   SKILL_DARKBOLT		    ,"MS10 Darkbolt" },
	{ "SH"		,   SKILL_DARKWAVE		    ,"MS12 Darkwave" },
	{ "SH"		,   SKILL_CURSELAZY		    ,"MS14 Curselazy" },
	{ "SH"		,   SKILL_L_PEACE		    ,"MS17 I_peace" },
	{ "SH"		,   SKILL_S_FLARE		    ,"MS20 S_Flare" },
	{ "SH"		,   SKILL_S_MANACLE		    ,"MS23 S_Manacle" },
	{ "SH"		,   SKILL_C_HUNT		    ,"MS26 C_Hunt" },
	{ "SH"		,   SKILL_A_MIGAL		    ,"MS30 A_Migal", "Sh2_A_MIGAL.tga" },
	{ "SH"		,   SKILL_R_MAKER		    ,"MS40 R_Maker", "Sh3_R_MAKER.tga" },
	{ "SH"		,   SKILL_L_GHOST		    ,"MS43 L_Ghost" },
	{ "SH"		,   SKILL_HAUNT		        ,"MS46 Haunt" },
	{ "SH"		,   SKILL_SCRATCH		    ,"MS50 Scratch" },
	{ "SH"		,   SKILL_R_KNIGHT		    ,"MS60 R_Knight", "Sh4_R_KNIGHT.tga" },
	{ "SH"		,   SKILL_JUDGE		        ,"MS63 Judge" },
	{ "SH"		,   SKILL_A_MIDRANDA		,"MS66 A_Midranda", "Sh4_A_MIDRANDA.tga" },
	{ "SH"		,   SKILL_M_PRAY		    ,"MS70 M_pray" },

	{"Èí¼ö·Â »ó½Â"	    ,CLANSKILL_ABSORB	 ,"","wa1-1.tga"},
	{"°ø°Ý·Â »ó½Â"      ,CLANSKILL_ATTACK	 ,"","wa1-3.tga"},
	{"È¸ÇÇÀ² »ó½Â"      ,CLANSKILL_EVASION	 ,"","wa1-2.tga"},

	{ "BC_SILVER"      ,BC_SKILL_SILVER	 ,"","wa1-3.tga" },
	{ "BC_BRONZE"      ,BC_SKILL_BRONZE	 ,"","wa1-3.tga" },
...
{ "Rei PVP", REIPVP, "", "PVP_Skill.tga" },
{ "Game Master", PLAYERGM, "", "pvp.tga" },
{ "Gladiador", PLAYER_ARENA, "", "gladiator.tga" },
{ "Top Level Classe", PLAYER_TOPLEVEL, "", "Sh5_CREED.tga" },
{ "Jogador Beta", PLAYERBETA, "", "beta.tga" }, // vou deixar essa imagem pra teste dps vc bota outra ai

	{ "Crystal1", 1, "", "hopy_crystal.tga" },
	{ "Crystal1", 2, "", "hobgoblin_crystal.tga" },
	{ "Crystal1", 3, "", "decoy_crystal.tga" },
	{ "Crystal1", 4, "", "bargon_crystal.tga" },
	{ "Crystal1", 5, "", "headcutter_crystal.tga" },
	{ "Crystal1", 6, "", "figon_crystal.tga" },
	{ "Crystal1", 7, "", "king_hopy_crystal.tga" },
	{ "Crystal1", 8, "", "hulk_crystal.tga" },
	{ "Crystal1", 9, "", "mystic_crystal.tga" },
	{ "Crystal1", 10, "", "gsaint_crystal.tga" },
	{ "Crystal1", 11, "", "web_crystal.tga" },
	{ "Crystal1", 12, "", "dark_specter_crystal.tga" },
	{ "Crystal1", 13, "", "iron_guard_crystal.tga" },
	{ "Crystal1", 17, "", "hopy_crystal.tga" },
	{ "Crystal1", 18, "", "hopy_crystal.tga" },
	{ "Crystal1", 19, "", "hopy_crystal.tga" },
};
...
cSKILL::cSKILL()
{
	memset(&ContinueSkill, 0, sizeof(sSKILL) * 30);
...
void cSKILL::Main()
{
	...
	CheckContinueIcon();
	memset(TempContinueSkill, 0, sizeof(sSKILL) * 30);
...
void cSKILL::LButtonUp(int x, int y)
{
	...
	if (SkillButtonIndex != 1 && SkillMasterFlag == 1)
	{
		...
		if (SkillButtonIndex <= 13 && SkillButtonIndex > 1 && sinSkill.SkillPoint > 0)
		{
			if (sinSkill.UseSkill[SkillButtonIndex - 1].Flag && sinSkill.UseSkill[SkillButtonIndex - 1].Use)
			{
				if (sinSkill.UseSkill[SkillButtonIndex - 1].Point < MAX_USE_SKILL_POINT)
	...
	if (SkillInfoShowFlag || sinMoveKindInter[SIN_SKILL])
	{
		...
		if (OpenFlag)
		{
			...
			if (sinSkill.SkillPoint >= 0 || sinSkill.SkillPoint4 >= 0)
			{
				...
				dsTextLineOut( CheckEditSize(165, 253, strBuff), 578 + (256 - sinMoveKindInter[SIN_SKILL]),
					strBuff, lstrlen(strBuff));


				wsprintf(strBuff, "%d", sinSkill.SkillPoint4);
				dsTextLineOut( CheckEditSize(250, 253, strBuff), 578 + (256 - sinMoveKindInter[SIN_SKILL]),
					strBuff, lstrlen(strBuff));
			...
			if (SkillMasteryShowFlag)
			{
				...
				dsTextLineOut( MasteryShowX, UseSkillMasteryPosi.y + 6 + (256 - sinMoveKindInter[SIN_SKILL]),
					strBuff, lstrlen(strBuff));
				...
				for (int j = 0; j < len2; j++)
				{
					if (szSkillInfoBuffBack[i] == '\r')
					{
						if (szSkillInfoBuff2Back[j] == '\r')
						{
							...
							SIZE sizecheck = { 0 };
							GetFontTextExtentPoint( pSkillInfo[Count], strlen(pSkillInfo[Count]), &sizecheck);
							...
							SetFontTextColor( RGB(210, 210, 210));
							...
							if (Count + 1 == 1)
							{
								...
								dsTextLineOut( SetTextXposi, SkillInfoBoxPosi.y + 27 + ((Count - 1) * 14), pSkillInfo[Count], Textlen);
								BoldFlag = 1;
							...
							if (Count + 1 == SkillUseWeaponClass)
							{
								...
								SetFontTextColor( RGB(117, 207, 0));
							}
							...
							{
								SetFontTextColor( RGB(220, 120, 255));
							}

							if (ChainDamageLine && Count + 1 == ChainDamageLine)
							{
								SetFontTextColor( RGB(170, 170, 255));
							}

							if (!BoldFlag)
							{
								dsTextLineOut( SetTextXposi, SkillInfoBoxPosi.y + 28 + ((Count - 1) * 15), pSkillInfo[Count], Textlen);

								COLORREF colour = GetTextColor(hdc);
								SetFontTextColor( RGB(173, 51, 243));
								dsTextLineOut( SetTextXposi2, SkillInfoBoxPosi.y + 28 + ((Count - 1) * 15), pSkillInfo2[Count], Textlen2);
				...
				for (int j = 0; j < len2; j++)
				{
					if (TempSkillInfo[i] == '\r')
					{
						if (TempSkillInfo2[j] == '\r')
						{
							...
							SetFontTextColor( RGB(239, 190, 109));
							...
							if (Count + 1 == 1)
							{
								...
								SetFontTextColor( RGB(222, 231, 255));
								dsTextLineOut( SetTextXposi, SkillUpInfoPosi.y + 27 + ((Count - 1) * 14), pSkillMasterInfo[Count], Textlen);
								BoldFlag = 1;
							...
							if (!BoldFlag)
							{
								dsTextLineOut( SetTextXposi, SkillUpInfoPosi.y + 28 + ((Count - 1) * 15), pSkillMasterInfo[Count], Textlen);
								dsTextLineOut( SetTextXposi2, SkillUpInfoPosi.y + 28 + ((Count - 1) * 15), pSkillMasterInfo2[Count], Textlen2);
								dsTextLineOut( SetTextXposi2 + 1, SkillUpInfoPosi.y + 28 + ((Count - 1) * 15), pSkillMasterInfo2[Count], Textlen2);
							}
							Count++;
							break;
						}
...
int cSKILL::ShowSkillInfo(sSKILL *pSkill, sSKILLBOX *pSkillBox, int Icon)
{
	...
	if (pSkill->Point)
	{
		if (pSkill->CODE == DELAY_GLOBAL || pSkill->CODE == QUEST_DIARY || pSkill->CODE == SKILL_FORCE_ORB || pSkill->CODE == CHANGE_JOB3_QUEST || pSkill->CODE == CHANGE_ELEMENTARY_QUEST)
		{
	...
	else
	{
		if (pSkill->CODE == CLANSKILL_ABSORB || pSkill->CODE == CLANSKILL_EVASION || pSkill->CODE == CLANSKILL_ATTACK ||
			...
			pSkill->CODE == BOOSTER_ITEM_LIFE || pSkill->CODE == BOOSTER_ITEM_MANA || pSkill->CODE == BOOSTER_ITEM_STAMINA || pSkill->CODE == REIPVP || pSkill->CODE == PLAYERGM || pSkill->CODE == BC_SKILL_SILVER || pSkill->CODE == BC_SKILL_BRONZE || pSkill->CODE == PLAYER_TOPLEVEL || pSkill->CODE == DELAY_GLOBAL || pSkill->CODE == PLAYER_ARENA || pSkill->CODE == QUEST_DIARY || pSkill->CODE == PLAYERBETA)
		{
			wsprintf(szSkillInfoBuff, "%s\r", pSkill->Skill_Info.SkillName);
		}
		else
	...
	else if (pSkill->CODE == SOD_SKILL_GOLD)
	{
		...
		lstrcat(szSkillInfoBuff, "Agilidade concedida  ao\rClã que sobreviveu ao Bellatra.\r\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "+ 1 Velocidade Atk\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
	...
	else if (pSkill->CODE == SOD_SKILL_SILVER)
	{
		...
		lstrcat(szSkillInfoBuff, "Agilidade concedida ao\rClã que sobreviveu ao Bellatra.\r\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "+ 10% Def\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
	...
	else if (pSkill->CODE == SOD_SKILL_BRONZE)
	{
		...
		lstrcat(szSkillInfoBuff, "Agilidade concedida ao\rClã que sobreviveu ao Bellatra.\r\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "+ 5% Atk Rt.\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");
	...
	else if (pSkill->CODE == REIPVP)
	{
		
		lstrcpy(szSkillInfoBuff, "Chefe de Classe\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "O Espírito da Batalha o acompanhar\rem todas as suas batalhas enquanto\rvocê for o maior assassino.\r\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "+ 3% de poder de ataque\r");
		lstrcat(szSkillInfoBuff, "+ 50 de vida\r");
		lstrcat(szSkillInfoBuff2, "\r");

		LineCount = 6;
	}
	else if (pSkill->CODE == PLAYERGM)
	{
		
		lstrcpy(szSkillInfoBuff, "Game Master\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff2, "\r");

		LineCount = 3;
	}
	else if (pSkill->CODE == PLAYERBETA)
	{

		lstrcpy(szSkillInfoBuff, "Honor Member\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "Membro de Honra GothicPT.\r\r");
		lstrcat(szSkillInfoBuff, "Adiciona +1 Speed\r");
	    lstrcat(szSkillInfoBuff2, "\r");

	LineCount = 3;
	}
	else if (pSkill->CODE == PLAYER_TOPLEVEL)
	{
		// ID
		lstrcpy(szSkillInfoBuff, "Chefe de Classe\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "Adiciona 100 de HP\r");
	...
	else if (pSkill->CODE == PLAYER_ARENA)
	{
		...
		lstrcpy(szSkillInfoBuff, "Gladiador\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "O Espírito da Batalha o acompanhar\rem todas as suas batalhas.\r\r");
		lstrcat(szSkillInfoBuff2, "\r");
		lstrcat(szSkillInfoBuff, "+ 5% de poder de ataque\r");
	...
	for (i = 0; i < 2; i++)
	{
		...
		case SKILL_S_FLARE:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", SpiritualFlare_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, ShootingRangeName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", SpiritualFlare_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			break;

		case SKILL_S_MANACLE:
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", SoulManacle_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;

		case SKILL_CURSELAZY:
			lstrcpy(szTempSkillDoc, DecreSpeed4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", CurseLazy_SpeedSubPercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, DecreAttack4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", CurseLazy_DamageSubPercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, MagicArea4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", CurseLazy_Area[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", CurseLazy_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_DARKBOLT:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", DarkBolt_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_DARKWAVE:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", DarkWave_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, ShootingRangeName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", DarkWave_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_JUDGE:
			...
			lstrcpy(szTempSkillDoc, ShootingRangeName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", Judgement_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_M_PRAY:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", MourningOfPray_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, AttackAreaName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", MourningOfPray_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_L_GHOST:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", LandGhost_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, AttackAreaName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", LandGhost_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_R_HIT:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Double_Blow_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_WISP:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Wisp_Reduction[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Wisp_UseTime[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_V_THRONE:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", VenomThorn_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;

		case SKILL_ALAS:
			lstrcpy(szTempSkillDoc, IncreEvasionPercent4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Alas_EvasionPercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Alas_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_S_SHOCK:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", SoulChock_Range[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", SoulChock_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;

		case SKILL_D_MASTERY:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", D_Mastery_DamagePercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;

		case SKILL_A_MASTERY:
			lstrcpy(szTempSkillDoc, AddEvasion4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", A_Mastery_AddPercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;

		case SKILL_F_MASTERY:
			lstrcpy(szTempSkillDoc, PlusCriticalName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", F_Mastery_Critical[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_S_SWORD:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", SoreSword_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_B_UP:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", BeatUp_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_INPES:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Inpes_Speed[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Inpes_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_A_MIGAL:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", AdventMigal_AttackRate[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", AdventMigal_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_A_MIDRANDA:
			lstrcpy(szTempSkillDoc, Attack_SpeedAdd);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", AdventMidranda_Speed[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", AdventMidranda_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_C_HUNT:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", ChasingHunt_Area[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", ChasingHunt_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_BLIND:
			...
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Blind_Time[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, MonsterSight7);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Blind_Range[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Blind_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_F_WIND:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", FrostWind_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_V_STAB:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", ViolenceStab_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_P_SHADOW:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", PastingShadow_Damage[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_SOUL_BREAKER:
			lstrcpy(szTempSkillDoc, DamageAddName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Soul_Breaker_DamagePercent[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, AddAttack_Rate9);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", Soul_Breaker_AttackRate[pSkill->Point + i - 1], "%");
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_HEALING:
			...
			wsprintf(szTempSkillDoc2, "%d-%d\r", Healing_Heal[pSkill->Point + i - 1][0], Healing_Heal[pSkill->Point + i - 1][1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_GRAND_HEALING:
			...
			wsprintf(szTempSkillDoc2, "%d-%d\r", Grand_Healing[pSkill->Point + i - 1][0], Grand_Healing[pSkill->Point + i - 1][1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case SKILL_DANCING_SWORD:
			...
			wsprintf(szTempSkillDoc2, "%d-%d\r", Dancing_Sword_FireDamage[pSkill->Point + i - 1][0], Dancing_Sword_FireDamage[pSkill->Point + i - 1][1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			...
			wsprintf(szTempSkillDoc2, "%d-%d\r", Dancing_Sword_IceDamage[pSkill->Point + i - 1][0], Dancing_Sword_IceDamage[pSkill->Point + i - 1][1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		...
		case PLAYER_ARENA:
		{
			lstrcpy(szTempSkillDoc, " + 5 % de poder de ataque\r");
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			LineCount++;
		}
		break;
		...
		case QUEST_DIARY:
		{
			lstrcpy(szTempSkillDoc, "Jogadores Eliminados:\r");
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "(%d/%d)\r", QuestDiaryKill1, QuestDiaryKill2);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		}
		break;
		...
		case BATTLE_LEVEL:
		{
			lstrcpy(szTempSkillDoc, "Experiência:\r");
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "(%d/%d)\r", CharBattleExp1, CharBattleExp2);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
		}
		break;
		...
		case SKILL_R_MAKER:
			lstrcpy(szTempSkillDoc, AddAbsorb4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", RainMaker_Absorb[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", RainMaker_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
		...
		case SKILL_R_KNIGHT:
			lstrcpy(szTempSkillDoc, sinAttackType);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			lstrcpy(szTempSkillDoc2, sinAttackType2[SummonSkillCodeIndex[3]]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, CountinueTime);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d%s\r", BloodyKnight_Time[pSkill->Point + i - 1], SecName);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, DamageName);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d-%d\r", BloodyKnight_Damage[pSkill->Point + i - 1][0], BloodyKnight_Damage[pSkill->Point + i - 1][1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, WolverinRate4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", BloodyKnight_Hit[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, WolverinDefense4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d\r", BloodyKnight_Defense[pSkill->Point + i - 1]);
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;

			lstrcpy(szTempSkillDoc, GolemLife4);
			lstrcat(szSkillInfoBuff, szTempSkillDoc);
			wsprintf(szTempSkillDoc2, "%d+(%d)\r", BloodyKnight_Life[pSkill->Point + i - 1], (sinChar->Strength * 2));
			lstrcat(szSkillInfoBuff2, szTempSkillDoc2);
			LineCount++;
			break;
...
{
	for (int k = 0; k < MAX_CONTINUE_SKILL; k++)
	{
		if (ContinueSkill[k].Flag)
		{
...
int cSKILL::SkillBarDraw(sSKILL *pSkill, int x, int y, int Alpha)
{
	...
	if (Time - 1 > 0)
		d3ddev->DrawPrimitiveUP(D3DPT_TRIANGLEFAN, Time - 1, tlVertex, sizeof(D3DTLVERTEX));
